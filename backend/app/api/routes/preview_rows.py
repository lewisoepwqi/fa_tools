...
def adjust_preview_row(row_id: str, payload: ManualAdjustmentRequest) -> dict[str, Any]:
...
def confirm_preview_row_route(row_id: str, payload: ConfirmationRequest) -> dict[str, Any]:
    return confirm_preview_row(row_id, payload.confirmed_by, payload.comment)
